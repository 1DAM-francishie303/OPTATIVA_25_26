...
function getTableroMarkup ($tablero, $coordenadasPersonaje){
   $tableroMarkup = "";
...
function getBotonesMarkup($coordenadasNuevaPosicion){
        return '<div>
        <a href="index.php?row=' . $coordenadasNuevaPosicion[2] . '&col=' . $coordenadasNuevaPosicion[1] . '">Arriba</a>
        <a href="index.php?row=' . $coordenadasNuevaPosicion[3] . '&col=' . $coordenadasNuevaPosicion[1] . '">Abajo</a>
        <a href="index.php?row=' . $coordenadasNuevaPosicion[0] . '&col=' . $coordenadasNuevaPosicion[4] . '">Derecha</a>
        <a href="index.php?row=' . $coordenadasNuevaPosicion[0] . '&col=' . $coordenadasNuevaPosicion[5] . '">Izquierda</a>
    </div>';
