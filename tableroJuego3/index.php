...
function getBotonesMarkup(){
    return '<div>
    <a href="http://localhost/TABLEROJUEGO2/index.php?row=$&col=$arrayCoordenadas[1]">Arriba</a>
    <a href="http://localhost/TABLEROJUEGO2/index.php?row=$&col=$arrayCoordenadas[1]">Abajo</a>
    <a href="http://localhost/TABLEROJUEGO2/index.php?row=$&col=$arrayCoordenadas[1]">Derecha</a>
    <a href="http://localhost/TABLEROJUEGO2/index.php?row=$&col=$arrayCoordenadas[1]">Izquierda</a>
    <div>';
}

function getCoordenadasPersonaje(){
    if(isset($_GET['row']) && isset($_GET['col'])){
        return array($_GET['row'], $_GET['col']);
    }
}
...
function getPosPersonaje($i){
    $arrayCoordenadas = getCoordenadasPersonaje();
    if($arrayCoordenadas[0] * 12 + $arrayCoordenadas[1] == $i){
